...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* 🎨 Style tombol */
    button {
      background: linear-gradient(135deg, #4a90e2, #66a6ff);
      border: none;
      padding: 12px 24px;
      border-radius: 30px;
      color: white;
...
<iframe width="200" height="200"
  ...
  allowfullscreen>
       ...
       <h2>Bila Video Tidak Bisa Diputar,ikuti langkah² ini</h2>

      <p>1.Buka Pengaturan Browser Di Pojok Kanan Atas<br></p>

      <p>2.Pencet "Mode Desktop Di Pengaturan"(Tidak peduli Nyala/Mati)<br></p>

      <p>3.Jika Muncul "Halaman Tidak Diketahui/ About Blank dan Sebagainya,Pencet Tombol "Back" Pada Handphone"<br></p>
  <footer>
